...
export default (() => {
  ...
  const attributeCols = technicalsCols.attributeColumns(
    (dictionaryId) => `/${params.facilityUrl}/admin/technicals/dictionaries/${dictionaryId}`,
  );
  ...
  return (
    <TQueryTable
      ...
      staticPersistenceKey="facilityAttributes"
      ...
      columns={[
        ...
        attributeCols.get("apiName", {initialVisible: false}),
        attributeCols.type,
        ...
        attributeCols.get("metadata", {initialVisible: false}),
      ...
      customSectionBelowTable={
        <div class="ml-2 flex gap-1">
          <Button class="secondary small" onClick={() => attributeCreateModal.show({facilityMode: true})}>
