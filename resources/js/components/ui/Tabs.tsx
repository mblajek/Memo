            ...
            <For each={props.tabs}>
              {(tab) => {
                ...
                return (
                  <Button
                    class={cx(
                      "shrink min-w-0 px-1.5 pt-1 hover:bg-hover rounded-t-lg border overflow-clip",
                      isActive()
                        ? "text-black border-input-border border-b-transparent"
                        : "text-black/70 border-gray-100 border-b-input-border",
                    )}
                    role="tab"
